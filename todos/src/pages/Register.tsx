  ...
  return <div>
    ...
    <div className="flex flex-col flex-1 items-center justify-center min-h-screen py-2">
        <div className="flex flex-col justify-center w-full max-w-sm px-4 py-8 bg-white shadow-lg rounded-lg">
            ...
            <h2 className="mb-6 text-xl font-semibold text-center text-gray-700">Register</h2>
            <form onSubmit={onSubmit}>
                ...
                <div className="flex items-center justify-between w-full mb-4 space-x-3">
                    <label htmlFor="passwordConfirmation" className="text-sm text-gray-600">Confirm Password</label>
                ...
                <button type="submit" className="block w-full px-4 py-2 mt-6 text-sm font-semibold text-center text-white transition duration-200 ease-in bg-white-600 rounded-lg hover:bg-blue-200 focus:outline-none focus:bg-primary-700 bg-black">Register</button>
            </form>
            <hr className="w-full my-6 border-gray-300" />
            <p className="text-sm text-center text-gray-600">Already have an account? <Link to={'/login'}><a href="#" className="text-primary-600 hover:text-primary-700">Sign in</a></Link></p>
        </div>
    </div>
